...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "ROMSIZE" -parent ${Page_0}
...
proc update_PARAM_VALUE.ROMSIZE { PARAM_VALUE.ROMSIZE } {
	# Procedure called to update ROMSIZE when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.ROMSIZE { PARAM_VALUE.ROMSIZE } {
	# Procedure called to validate ROMSIZE
	return true
}
...
proc update_MODELPARAM_VALUE.ROMSIZE { MODELPARAM_VALUE.ROMSIZE PARAM_VALUE.ROMSIZE } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.ROMSIZE}] ${MODELPARAM_VALUE.ROMSIZE}
}
