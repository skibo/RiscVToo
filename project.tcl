...
#
# project.tcl: Tcl script for re-creating project 'RiscVToo'
#
# Generated by Vivado on Sat Jan 06 14:18:05 PST 2024
...
#    "./RiscVToo.srcs/testsw_1/test3.mem"
#
#*****************************************************************************************
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/RiscVToo.srcs/source_1/cpu/riscv_core.v"]"\
 "[file normalize "$origin_dir/RiscVToo.srcs/source_1/cpu/riscv_cpu.v"]"\
 ...
 "[file normalize "$origin_dir/RiscVToo.srcs/testsw_1/test3.mem"]"\
  ]
  foreach ifile $files {
  ...
  set paths [list \
 "[file normalize "$origin_dir/../../../../tmp/[file normalize "$origin_dir/"]"]"\
  ]
  foreach ipath $paths {
...
set orig_proj_dir "[file normalize "$origin_dir/RiscVToo"]"
...
set_property -name "top" -value "riscv_too" -objects $obj
...
set file "$origin_dir/RiscVToo.srcs/testsw_1/test_too.mem"
set file [file normalize $file]
...
set file "$origin_dir/RiscVToo.srcs/testsw_1/test_timer.mem"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "file_type" -value "Memory File" -objects $file_obj

set file "$origin_dir/RiscVToo.srcs/testsw_1/test2.mem"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "file_type" -value "Memory File" -objects $file_obj

set file "$origin_dir/RiscVToo.srcs/testsw_1/test1.mem"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "file_type" -value "Memory File" -objects $file_obj

set file "$origin_dir/RiscVToo.srcs/testsw_1/testcsr.mem"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "file_type" -value "Memory File" -objects $file_obj

set file "$origin_dir/RiscVToo.srcs/testsw_1/test3.mem"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "file_type" -value "Memory File" -objects $file_obj
...
set obj [get_filesets sim_1]
set_property -name "top" -value "test_riscv_too" -objects $obj
set_property -name "top_auto_set" -value "0" -objects $obj
